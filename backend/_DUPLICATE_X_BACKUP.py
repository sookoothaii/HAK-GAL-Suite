# -*- coding: utf-8 -*-
# k_assistant.py - Merged and Corrected Version v5
# Unabridged version with full prompts and synonym maps.
...
class KAssistant:
    ...
    def _normalize_and_correct_syntax(self, formula: str) -> str:
        ...
        corrected = re.sub(r'\bHAK-GAL\b', 'HAK_GAL_Suite', formula, flags=re.IGNORECASE)
        ...
        if corrected != original_formula: print(f"   [Syntax-Korrektur] '{original_formula.strip()}' -> '{corrected.strip()}'")
        return corrected
