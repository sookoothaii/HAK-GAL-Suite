# -*- coding: utf-8 -*-
# k_assistant.py - Merged and Corrected Version v6
# Fixes inconsistent normalization for hyphenated entities to ensure
# queries match facts in the knowledge base.
